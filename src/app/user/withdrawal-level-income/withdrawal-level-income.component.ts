...
@Component({
  ...
  styleUrls: ['./withdrawal-level-income.component.scss']
})
export class WithdrawalLevelIncomeComponent {
  ...
  async ngOnInit() {
    let res = (await this.details.getWithdrawalLevelIncome(sessionStorage.getItem('UserAddress'))).data;
    // console.log(res)
